                    ...
                    <div class="col-md-7 col-lg-7 col-sm-5 col-xs-12">
                        <div class="product__details__container product-details-5">
                            <div class="scroll-single-product mb--30">
                                <img src="/storage/images/system/product-details/big-img/10.jpg" alt="full-image">
                            </div>
                            <div class="scroll-single-product mb--30">
                                <img src="/storage/images/system/product-details/big-img/11.jpg" alt="full-image">
                            </div>
                            <div class="scroll-single-product mb--30">
                                <img src="/storage/images/system/product-details/big-img/12.jpg" alt="full-image">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="review__address__inner">
                                ...
                                <div class="pro__review">
                                    <div class="review__thumb">
                                        <img src="/storage/images/system/review/1.jpg" alt="review images">
                                    </div>
                                ...
                                <div class="pro__review ans">
                                    <div class="review__thumb">
                                        <img src="/storage/images/system/review/2.jpg" alt="review images">
                                    </div>
                                    <div class="review__details">
                                        <div class="review__info">
                                            <h4><a href="#">Gerald Barnes</a></h4>
