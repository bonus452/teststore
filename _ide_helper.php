...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Helpers\BreadcrumbsManager $instance */
         ...
         */ 
        public static function for($name, $callback)
        {            //Method inherited from \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager         
                        /** @var \App\Helpers\BreadcrumbsManager $instance */
        ...
        public static function macro($name, $macro)
        {            //Method inherited from \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager         
                        \App\Helpers\BreadcrumbsManager::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {            //Method inherited from \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager         
                        \App\Helpers\BreadcrumbsManager::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {            //Method inherited from \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager         
                        return \App\Helpers\BreadcrumbsManager::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {            //Method inherited from \DaveJamesMiller\Breadcrumbs\BreadcrumbsManager         
                        \App\Helpers\BreadcrumbsManager::flushMacros();
        }
