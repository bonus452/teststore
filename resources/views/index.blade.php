...
@section('content')
                        ...
                        <div class="category-menu-list">
                            ...
                            <ul>
                                @foreach($catalog_menu as $menu_item)
                                    <li>
                                        <a href="{{ $menu_item->url }}">{{ $menu_item->title }} @if($menu_item->getCustomProp('sub_categories')->IsNotEmpty())
                                                <i class="zmdi zmdi-chevron-right"></i>
                                            @endif </a>
                                        @if($menu_item->getCustomProp('sub_categories')->IsNotEmpty())
                                            <div class="category-menu-dropdown">
                                                @include('include.catalog_partial_menu', ['catalog_menu' => $menu_item->getCustomProp('sub_categories'), 'last_level' => false])
                                            </div>
                                        @endif
    ...
    <div class="only-banner ptb--100 bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="shop-sidebar.html"><img src="storage/images/system/new-product/3.jpg" alt="new product"></a>
            </div>
        </div>
    </div>
    ...
    <div class="only-banner ptb--100 bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="shop-sidebar.html"><img src="storage/images/system/new-product/6.jpg" alt="new product"></a>
            </div>
        </div>
    </div>
    <!-- Start Our Product Area -->
    ...
    <div class="only-banner bg__white">
        <div class="container">
            <div class="only-banner-img">
                <a href="shop-sidebar.html"><img src="storage/images/system/new-product/7.jpg" alt="new product"></a>
            </div>
        </div>
    </div>
    <!-- Start Our Product Area -->
                            ...
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="storage/images/system/blog/blog-img/1.jpg" alt="blog images">
                                    </a>
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="blog foo">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="storage/images/system/blog/blog-img/2.jpg" alt="blog images">
                                    </a>
                                    <div class="blog__post__time">
                                        <div class="post__time--inner">
                                            <span class="date">14</span>
                    ...
                    <div class="col-md-4 col-lg-4 hidden-sm col-xs-12">
                        <div class="blog foo">
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src="storage/images/system/blog/blog-img/3.jpg" alt="blog images">
                                    </a>
                                    <div class="blog__post__time">
                                        <div class="post__time--inner">
                                            <span class="date">14</span>
