...
(function( $, window, document, undefined ) {
	 ...
	 *     [
	 *       {
	 *         name:      'data'                -- string   - PropertyValue name
	...
	var __row_selector = function ( settings, selector, opts )
	{
		...
		var run = function ( sel ) {
			...
			// Selector - node
			if ( sel.nodeName ) {
				var rowIdx = sel._DT_RowIndex;  // PropertyValue added by DT for fast lookup
	...
	DataTable.models.oColumn = {
		...
		/**
		 * PropertyValue to read the value for the cells in the column from the data
	...
	DataTable.models.oSettings = {
		...
		/**
		 * PropertyValue from a given object from which to read the table data from. This
